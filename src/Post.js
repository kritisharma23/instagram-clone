...
function Post({postId, user, username, caption, imageUrl, right_column}) {
    ...
    return (
        <div className="post">
            ...
            {right_column && (
                    <button className="post__viewInstagram"
                        onClick={(e) => {
                        e.preventDefault();
                        window.open('https://www.instagram.com/p/CNVXguwl_wi/', "_blank");
                        }}
